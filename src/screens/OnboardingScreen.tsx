...
export function OnboardingScreen() {
  ...
  const { signInAnonymously, completeOnboarding } = useAuthStore();
  ...
  }, [signInAnonymously, completeOnboarding, navigation]);
